    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-teal-50 to-blue-50 px-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8">
        ...
        <div className="text-center mb-8">
          <div className="w-20 h-20 bg-gradient-to-br from-teal-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-4">
            <span className="text-white font-bold text-2xl">MyMA</span>
          </div>
          <h1 className="text-3xl font-bold text-[#111318] mb-2">Bienvenido</h1>
          <p className="text-[#616f89]">Inicia sesión con tu cuenta empresarial de Google</p>
        </div>
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3 px-4 bg-white border-2 border-gray-300 hover:border-gray-400 text-[#111318] font-medium rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 shadow-sm hover:shadow-md"
        >
          {loading ? (
            <>
